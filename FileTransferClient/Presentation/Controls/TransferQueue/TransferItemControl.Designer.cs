...
namespace FileTransferClient.Presentation.Controls.TransferQueue
{
    partial class TransferItemControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "TransferItemControl";
            this.Load += new System.EventHandler(this.TransferItemControl_Load);
            this.ResumeLayout(false);

        }

        private void TransferItemControl_Load(object sender, EventArgs e)
        {
